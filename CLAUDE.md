...
**Este repo:** Worker Python "Heimdall Eye" (heimdall-eye.py): RTSP -> movimiento MOG2 -> CLIP ViT-B/32 -> alerta (S3 + storeRegister + notify). Se publica a S3 con deploy-worker.sh.
